...
export default class WBV3DObjectWidget extends WBVSectionWidget {
    constructor(parent = null, view = null, classnames = []) {
        super(parent, 'Object Details', classnames);
        this.view = view;
        this.object = null;
        var that = this;
        const mat = this.object ? this.object.material : new THREE.MeshLambertMaterial();
        ...
        $(document).on('click', '.new_plan', function () {
            if (!mat.clippingPlanes)
                mat.clippingPlanes = [];
            mat.clippingPlanes.push(new THREE.Plane(new THREE.Vector3(1, 0, 0), 0));
            that.update();
        });
...
//# sourceMappingURL=WBV3DObjectWidget.js.map